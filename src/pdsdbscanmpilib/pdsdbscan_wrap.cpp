...
/*-----------------------------------------------
              @(target):= _pdsdbscan.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pdsdbscan

#else
#  define SWIG_init    init_pdsdbscan

#endif
#define SWIG_name    "_pdsdbscan"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_run_pdsdbscan(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "run_pdsdbscan", 6, 6, swig_obj)) SWIG_fail;
  {
    MPI_Comm *ptr = (MPI_Comm *)0;
    int res = SWIG_AsPtr_MPI_Comm(swig_obj[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "run_pdsdbscan" "', argument " "1"" of type '" "MPI_Comm""'"); 
    }
    arg1 = *ptr;
  ...
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "run_pdsdbscan" "', argument " "5"" of type '" "int""'");
  } 
  arg5 = static_cast< int >(val5);
  ecode6 = SWIG_AsVal_double(swig_obj[3], &val6);
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "run_pdsdbscan" "', argument " "6"" of type '" "double""'");
  } 
  arg6 = static_cast< double >(val6);
  ecode7 = SWIG_AsVal_int(swig_obj[4], &val7);
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "run_pdsdbscan" "', argument " "7"" of type '" "int""'");
  } 
  arg7 = static_cast< int >(val7);
  {
    ...
    arg9 = (int) PyLong_AsSsize_t(swig_obj[5]);
    if (arg9 == -1 && PyErr_Occurred()) SWIG_fail;
    dims[0] = (npy_intp) arg9;
    array8 = PyArray_SimpleNew(1, dims, NPY_INT);
    if (!array8) SWIG_fail;
    arg8 = (int*) array_data(array8);
  }
  result = (int)run_pdsdbscan(arg1,(float const *)arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "run_pdsdbscan", _wrap_run_pdsdbscan, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_Python_SetConstant(d, "RESULT_OK",SWIG_From_int(static_cast< int >(0)));
  SWIG_Python_SetConstant(d, "RESULT_WRONG_INPUT",SWIG_From_int(static_cast< int >(1)));
  SWIG_Python_SetConstant(d, "RESULT_BAD_NUMBER_OF_PROCESSES",SWIG_From_int(static_cast< int >(2)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
